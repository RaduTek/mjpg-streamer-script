...
# Plugin parameters
INPUT_PLUGIN="input_uvc.so -d /dev/v4l/by-id/$CAMERA_ID -r $CAMERA_RES"
OUTPUT_PLUGIN="output_http.so -p $WEB_PORT -w $WEB_ROOT"
...
# Start command
START_CMD="mjpg_streamer -i '$INPUT_PLUGIN' -o '$OUTPUT_PLUGIN'"
